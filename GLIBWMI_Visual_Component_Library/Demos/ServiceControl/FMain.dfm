object FormMain: TFormMain
  ...
  object ServiceInfo1: TServiceInfo
    ...
    AllProperties.Strings = (
        ...
        'tivas no las recibir'#1073'n. Si el servicio se deshabilita, no se pod' +
        'r'#1073' iniciar ninguno de los servicios que dependen expl'#1085'citamente ' +
        'dependen de '#1081'l.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Serv' +
        ...
        'aci'#1091'n";'#10#9'CheckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9 +
        'Description = "Proporciona compatibilidad para complementos de p' +
        'rotocolo de terceros para Conexi'#1091'n compartida a Internet y para ' +
        'Firewall de Windows.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = ' +
        '"Servicio de puerta de enlace de capa de aplicaci'#1091'n";'#10#9'ErrorCont' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Administraci'#1091'n de aplicaciones";'#10#9'CheckPoint' +
        ' = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description = "Ofre' +
        'ce servicios de instalaci'#1091'n de software como Asignar, Publicar y' +
        ' Quitar.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Administrac' +
        'i'#1091'n de aplicaciones";'#10#9'ErrorControl = "Normal";'#10#9'ExitCode = 1077' +
        ...
        'rciona compatibilidad para los estados de sesi'#1091'n fuera de proces' +
        'o de ASP.NET. Si se detiene este servicio, no se procesar'#1073'n las ' +
        'solicitudes fuera de proceso. Si se deshabilita este servicio, l' +
        'os servicios que dependan expl'#1085'citamente del mismo, fallar'#1073'n al ' +
        ...
        'ste servicio, los dispositivos de audio y efectos no funcionar'#1073'n' +
        ' correctamente. Si se deshabilita este servicio, cualquier servi' +
        'cio que dependa expl'#1085'citamente de '#1081'l tendr'#1073' un error al iniciar.' +
        ...
        ' en segundo plano. Si est'#1073' deshabilitado BITS, hay caracter'#1085'stic' +
        'as como Windows Update que no funcionar'#1073'n correctamente.";'#10#9'Desk' +
        ...
        'rvicio, esta lista no se actualizar'#1073' o mantendr'#1073'. Si se deshabil' +
        'ita el servicio, no se podr'#1073' iniciar ninguno de los servicios qu' +
        'e dependan expl'#1085'citamente de '#1081'l.";'#10#9'DesktopInteract = FALSE;'#10#9'Di' +
        ...
        'otos; ofrece acceso inmediato a archivos a trav'#1081's de un lenguaje' +
        ...
        'ortafolios para almacenar informaci'#1091'n y compartirla con equipos ' +
        'remotos. Si se detiene el servicio,  el Visor del Portafolios no' +
        ' podr'#1073' compartir informaci'#1091'n con los equipos remotos. Si se desh' +
        'abilita este servicio, cualquier servicio que expl'#1085'citamente dep' +
        'enda de '#1081'l no podr'#1073' iniciarse.";'#10#9'DesktopInteract = FALSE;'#10#9'Disp' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Aplicaci'#1091'n del sistema COM+";'#10#9'CheckPoint = ' +
        '0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description = "Adminis' +
        'tra la configuraci'#1091'n y el seguimiento de los componentes del Mod' +
        'elo de objetos componentes (COM+). Si se detiene el servicio, la' +
        ' mayor'#1085'a de los componentes COM+ no funcionar'#1073'n correctamente. S' +
        'i se deshabilita este servicio, no se podr'#1073' iniciar ning'#1098'n servi' +
        'cio que dependa espec'#1085'ficamente de '#1081'l.";'#10#9'DesktopInteract = FALS' +
        'E;'#10#9'DisplayName = "Aplicaci'#1091'n del sistema COM+";'#10#9'ErrorControl =' +
        ...
        's servicios de administraci'#1091'n: Servicio de cat'#1073'logo de base de d' +
        'atos, que confirma las firmas de archivos de Windows; Servicio d' +
        'e ra'#1085'z protegida, que agrega y quita certificados de entidades e' +
        'misoras de ra'#1085'z de confianza de este equipo; y el Servicio de cl' +
        'aves, que ayuda a inscribir este equipo a certificados. Si se de' +
        'tiene este servicio, sus servicios de administraci'#1091'n mencionados' +
        ' no funcionar'#1073'n correctamente. Si se deshabilita este servicio, ' +
        'no se podr'#1073'n iniciar ninguno de los servicios que dependen expl'#1085 +
        'citamente de '#1081'l.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Ser' +
        ...
        'ci'#1091'n de la red registrando y actualizando direcciones IP y nombr' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Servicio del administrador de discos l'#1091'gicos' +
        '";'#10#9'CheckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Descr' +
        'iption = "Configura las unidades de disco duro y vol'#1098'menes. El s' +
        'ervicio s'#1091'lo se ejecuta para procesos de configuraci'#1091'n y a conti' +
        'nuaci'#1091'n se detiene.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "' +
        'Servicio del administrador de discos l'#1091'gicos";'#10#9'ErrorControl = "' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' TRUE;'#10#9'Caption = "Administrador de discos l'#1091'gicos";'#10#9'CheckPoint' +
        ' = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description = "Dete' +
        'cta y supervisa unidades de disco duro nuevas y env'#1085'a informaci'#1091 +
        'n del volumen de disco al Servicio de administraci'#1091'n de discos l' +
        #1091'gicos para su configuraci'#1091'n. Si se detiene este servicio, la in' +
        'formaci'#1091'n de estado y configuraci'#1091'n de discos din'#1073'micos puede qu' +
        'edar desactualizada. Si se deshabilita este servicio, no se podr' +
        #1073' iniciar ninguno de los servicios que dependan expl'#1085'citamente d' +
        'e '#1081'l.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Administrador ' +
        'de discos l'#1091'gicos";'#10#9'ErrorControl = "Normal";'#10#9'ExitCode = 0;'#10#9'Na' +
        ...
        'ach'#1081' los nombres del  sistema de nombres de dominio (DNS) para e' +
        'ste equipo. Si se detiene este servicio, este equipo no podr'#1073' re' +
        'solver nombres DNS ni ubicar controladores de dominio en Active ' +
        'Directory. Si se deshabilita este servicio, no se podr'#1073' iniciar ' +
        'ninguno de los servicios que dependen expl'#1085'citamente de '#1081'l.";'#10#9'D' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Configuraci'#1091'n autom'#1073'tica de redes cableadas"' +
        ';'#10#9'CheckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Descri' +
        'ption = "Este servicio realiza la autenticaci'#1091'n IEEE 802.1X en i' +
        'nterfaces Ethernet";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "C' +
        'onfiguraci'#1091'n autom'#1073'tica de redes cableadas";'#10#9'ErrorControl = "No' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Servicio de protocolo de autenticaci'#1091'n exten' +
        ...
        ' de protocolo de autenticaci'#1091'n extensible";'#10#9'DesktopInteract = F' +
        'ALSE;'#10#9'DisplayName = "Servicio de protocolo de autenticaci'#1091'n ext' +
        ...
        'cutan en entornos no est'#1073'ndar.";'#10#9'DesktopInteract = FALSE;'#10#9'Disp' +
        ...
        'rvicio de notificaci'#1091'n de eventos del sistema (SENS), que propor' +
        'ciona la distribuci'#1091'n autom'#1073'tica de eventos a los componentes de' +
        'l Modelo de objetos componentes (COM). Si se detiene este servic' +
        'io, SENS se cerrar'#1073' y no podr'#1073' ofrecer notificaciones de inicio ' +
        'ni de cierre de sesi'#1091'n. Si se deshabilita el servicio, no se pod' +
        'r'#1073' iniciar ning'#1098'n servicio que dependa espec'#1085'ficamente de '#1081'l.";'#10 +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' TRUE;'#10#9'Caption = "Compatibilidad de cambio r'#1073'pido de usuario";'#10 +
        #9'CheckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Descript' +
        'ion = "Proporciona administraci'#1091'n para aplicaciones que necesita' +
        'n asistencia en un entorno de usuarios m'#1098'ltiples.";'#10#9'DesktopInte' +
        'ract = FALSE;'#10#9'DisplayName = "Compatibilidad de cambio r'#1073'pido de' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' TRUE;'#10#9'Caption = "Ayuda y soporte t'#1081'cnico";'#10#9'CheckPoint = 0;'#10#9'C' +
        'reationClassName = "Win32_Service";'#10#9'Description = "Habilita la ' +
        'ejecuci'#1091'n del Centro de ayuda y soporte t'#1081'cnico en este equipo. ' +
        'Si se detiene este servicio, el Centro de ayuda y soporte t'#1081'cnic' +
        'o no estar'#1073' disponible. Si se deshabilita este servicio, no se p' +
        'odr'#1073' iniciar ninguno de los servicios que dependan expl'#1085'citament' +
        'e de '#1081'l.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Ayuda y sop' +
        'orte t'#1081'cnico";'#10#9'ErrorControl = "Normal";'#10#9'ExitCode = 0;'#10#9'Name = ' +
        ...
        'n = "Habilita el acceso de entrada gen'#1081'rico a los Dispositivos d' +
        ...
        'ar'#1073'n de funcionar. Si este servicio est'#1073' deshabilitado, cualquie' +
        'r servicio que expl'#1085'citamente dependa de '#1081'l no podr'#1073' iniciarse."' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Servicio de administraci'#1091'n de certificados y' +
        ...
        #10#9'DisplayName = "Servicio de administraci'#1091'n de certificados y cl' +
        ...
        'cio, no se podr'#1073' iniciar ning'#1098'n servicio que dependa expl'#1085'citame' +
        'nte de '#1081'l.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "HTTP SSL"' +
        ...
        'i'#1091'n, administraci'#1091'n y divulgaci'#1091'n de identidades digitales de un' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Servicio COM de grabaci'#1091'n de CD de IMAPI";'#10#9 +
        'CheckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Descripti' +
        'on = "Administra la grabaci'#1091'n de CD usando la interfaz de progra' +
        'maci'#1091'n de aplicaciones de grabaci'#1091'n de im'#1073'genes (IMAPI). Si se d' +
        'etiene este servicio, el equipo no podr'#1073' grabar los CD. Si est'#1073' ' +
        'deshabilitado, los servicios que dependan de '#1081'ste no se iniciar'#1073 +
        'n.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Servicio COM de g' +
        'rabaci'#1091'n de CD de IMAPI";'#10#9'ErrorControl = "Normal";'#10#9'ExitCode = ' +
        ...
        'unciones no estar'#1073'n disponibles. Si se deshabilita el servicio, ' +
        'no se podr'#1073' iniciar ninguno de los servicios que dependan expl'#1085'c' +
        'itamente de '#1081'l.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Serv' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = TRUE;'#10#9'AcceptStop = ' +
        'TRUE;'#10#9'Caption = "Estaci'#1091'n de trabajo";'#10#9'CheckPoint = 0;'#10#9'Creati' +
        ...
        'el servicio, estas conexiones no estar'#1073'n disponibles. Si se desh' +
        'abilita el servicio, no se podr'#1073' iniciar ninguno de los servicio' +
        's que dependan expl'#1085'citamente de '#1081'l.";'#10#9'DesktopInteract = FALSE;' +
        #10#9'DisplayName = "Estaci'#1091'n de trabajo";'#10#9'ErrorControl = "Normal";' +
        ...
        'ta la compatibilidad con NetBIOS a trav'#1081's del servicio TCP/IP (N' +
        'etBT) y la resoluci'#1091'n de nombres NetBIOS.";'#10#9'DesktopInteract = F' +
        ...
        'assName = "Win32_Service";'#10#9'Description = "Ofrece protecci'#1091'n de ' +
        'an'#1073'lisis en tiempo real de McAfee para su equipo.";'#10#9'DesktopInte' +
        ...
        'ar las actividades de an'#1073'lisis y actualizaci'#1091'n de McAfee.";'#10#9'Des' +
        ...
        'i'#1091'n local y remota para depuradores de secuencia de comandos de ' +
        'Visual Studio. Si este servicio se detiene, los depuradores no f' +
        'uncionar'#1073'n adecuadamente.";'#10#9'DesktopInteract = TRUE;'#10#9'DisplayNam' +
        ...
        'res. Este servicio no est'#1073' relacionado con Windows Messenger. Si' +
        ' se detiene el servicio, no se transmitir'#1073'n los mensajes de aler' +
        'ta. Si se deshabilita el servicio, no se podr'#1073' iniciar ninguno d' +
        'e los servicios que dependan expl'#1085'citamente de '#1081'l.";'#10#9'DesktopInt' +
        ...
        ', estas transacciones no se producir'#1073'n. Si se deshabilita el ser' +
        'vicio, no se podr'#1073' iniciar ning'#1098'n servicio que dependa espec'#1085'fic' +
        'amente de '#1081'l.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Coordi' +
        ...
        'taller (*.msi). Si se deshabilita este servicio, no se podr'#1073' ini' +
        'ciar ninguno de los servicios que dependan expl'#1085'citamente de '#1081'l.' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Agente de Protecci'#1091'n de acceso a redes";'#10#9'Ch' +
        'eckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description' +
        ' = "Permite a los clientes de Windows participar en la Protecci'#1091 +
        'n de acceso a redes";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "' +
        'Agente de Protecci'#1091'n de acceso a redes";'#10#9'ErrorControl = "Normal' +
        ...
        'ridad en la red para el Intercambio din'#1073'mico de datos (DDE) para' +
        ' los programas que se ejecutan en el mismo equipo o en diferente' +
        's equipos. Si este servicio se detiene, se deshabilitar'#1073'n el tra' +
        'nsporte y la seguridad DDE. Si este servicio est'#1073' deshabilitado,' +
        ' cualquier servicio que expl'#1085'citamente dependa de '#1081'l no podr'#1073' in' +
        ...
        'ecursos de red Intercambio din'#1073'mico de datos (DDE). Si este serv' +
        'icio se detiene, se deshabilitar'#1073'n los recursos compartidos de r' +
        'ed DDE. Si este servicio est'#1073' deshabilitado, cualquier servicio ' +
        'que expl'#1085'citamente dependa de '#1081'l no podr'#1073' iniciarse.";'#10#9'DesktopI' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Inicio de sesi'#1091'n en red";'#10#9'CheckPoint = 0;'#10#9 +
        'CreationClassName = "Win32_Service";'#10#9'Description = "Admite la a' +
        'utenticaci'#1091'n de paso de sucesos de inicio de sesi'#1091'n de cuenta pa' +
        'ra los equipos en un dominio.";'#10#9'DesktopInteract = FALSE;'#10#9'Displ' +
        'ayName = "Inicio de sesi'#1091'n en red";'#10#9'ErrorControl = "Normal";'#10#9'E' +
        ...
        ' en la carpeta Conexiones de red y acceso telef'#1091'nico, donde se p' +
        'ueden ver conexiones de red de '#1073'rea local y remotas.";'#10#9'DesktopI' +
        ...
        #1081's del protocolo net.tcp.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayNa' +
        ...
        'opila y almacena informaci'#1091'n de configuraci'#1091'n y ubicaci'#1091'n de red' +
        'es, e informa a las aplicaciones cuando esta informaci'#1091'n cambia.' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Medios de almacenamiento extra'#1085'bles";'#10#9'Check' +
        ...
        'namiento extra'#1085'bles";'#10#9'ErrorControl = "Normal";'#10#9'ExitCode = 1077' +
        ...
        'hivos de instalaci'#1091'n utilizados para las actualizaciones y repar' +
        'aciones, y es necesario para descargar  actualizaciones del prog' +
        'rama de instalaci'#1091'n e informes de error de Watson.";'#10#9'DesktopInt' +
        ...
        'servicio, el sistema se volver'#1073' inestable. ";'#10#9'DesktopInteract =' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Administrador de conexi'#1091'n autom'#1073'tica de acce' +
        'so remoto";'#10#9'CheckPoint = 0;'#10#9'CreationClassName = "Win32_Service' +
        '";'#10#9'Description = "Crea una conexi'#1091'n a una red remota siempre qu' +
        'e un programa hace referencia a un nombre o direcci'#1091'n DNS o NetB' +
        'ios remoto.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Administ' +
        'rador de conexi'#1091'n autom'#1073'tica de acceso remoto";'#10#9'ErrorControl = ' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' TRUE;'#10#9'Caption = "Administrador de conexi'#1091'n de acceso remoto";'#10 +
        #9'CheckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Descript' +
        'ion = "Crea una conexi'#1091'n de red.";'#10#9'DesktopInteract = FALSE;'#10#9'Di' +
        'splayName = "Administrador de conexi'#1091'n de acceso remoto";'#10#9'Error' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Administrador de sesi'#1091'n de Ayuda de escritor' +
        ...
        'i se detiene este servicio, Asistencia remota no estar'#1073' disponib' +
        'le. Antes de detener el servicio, vea la ficha Dependencias en e' +
        'l cuadro de di'#1073'logo Propiedades.";'#10#9'DesktopInteract = FALSE;'#10#9'Di' +
        'splayName = "Administrador de sesi'#1091'n de Ayuda de escritorio remo' +
        ...
        ' servicios de enrutamiento a empresas en entornos de red de '#1073'rea' +
        ...
        'emotos para que modifiquen la configuraci'#1091'n del Registro en este' +
        ' equipo. Si se detiene este servicio, cualquier usuario en este ' +
        'equipo puede modificar el Registro. Si este servicio est'#1073' deshab' +
        'ilitado, cualquier servicio que expl'#1085'citamente dependa de '#1081'l no ' +
        'podr'#1073' iniciarse.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Reg' +
        ...
        #1089'alizaci'#1091'n de red y control del tr'#1073'fico local para programas y s' +
        ...
        '= "Almacena informaci'#1091'n de seguridad de cuentas de usuario local' +
        ...
        ' este servicio se detiene, el equipo no podr'#1073' leer las tarjetas ' +
        'inteligentes. Si este servicio est'#1073' deshabilitado, cualquier ser' +
        'vicio que expl'#1085'citamente dependa de '#1081'l no podr'#1073' iniciarse.";'#10#9'De' +
        ...
        'ario para que configure y programe tareas autom'#1073'ticas en este eq' +
        'uipo. Si se detiene este equipo, estas tareas no se ejecutar'#1073'n e' +
        'n sus horas programadas. Si este servicio est'#1073' deshabilitado, cu' +
        'alquier servicio que expl'#1085'citamente dependa de '#1081'l no podr'#1073' inici' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = TRUE;'#10#9'AcceptStop = ' +
        'TRUE;'#10#9'Caption = "Inicio de sesi'#1091'n secundario";'#10#9'CheckPoint = 0;' +
        ...
        'ste servicio, se deshabilitar'#1073' este tipo de acceso de inicio de ' +
        'sesi'#1091'n. Si este servicio est'#1073' deshabilitado, cualquier servicio ' +
        'que expl'#1085'citamente dependa de '#1081'l no podr'#1073' iniciarse.";'#10#9'DesktopI' +
        'nteract = TRUE;'#10#9'DisplayName = "Inicio de sesi'#1091'n secundario";'#10#9'E' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' TRUE;'#10#9'Caption = "Notificaci'#1091'n de sucesos del sistema";'#10#9'CheckP' +
        'oint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description = "' +
        'Registra sucesos del sistema como los de inicio de sesi'#1091'n en Win' +
        'dows, red y energ'#1085'a, y los notifica a los suscriptores de suceso' +
        's del sistema COM+.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "' +
        'Notificaci'#1091'n de sucesos del sistema";'#10#9'ErrorControl = "Normal";'#10 +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' TRUE;'#10#9'Caption = "Firewall de Windows/Conexi'#1091'n compartida a Int' +
        'ernet (ICS)";'#10#9'CheckPoint = 0;'#10#9'CreationClassName = "Win32_Servi' +
        'ce";'#10#9'Description = "Ofrece servicios de traducci'#1091'n de direccion' +
        'es, direccionamiento, resoluci'#1091'n de nombres y/o servicios de pre' +
        'venci'#1091'n de intrusi'#1091'n para una red dom'#1081'stica o de peque'#1089'a empresa' +
        '.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Firewall de Window' +
        's/Conexi'#1091'n compartida a Internet (ICS)";'#10#9'ErrorControl = "Normal' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = TRUE;'#10#9'AcceptStop = ' +
        'TRUE;'#10#9'Caption = "Detecci'#1091'n de hardware shell";'#10#9'CheckPoint = 0;' +
        ...
        'Interact = FALSE;'#10#9'DisplayName = "Detecci'#1091'n de hardware shell";'#10 +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' TRUE;'#10#9'Caption = "Cola de impresi'#1091'n";'#10#9'CheckPoint = 0;'#10#9'Creatio' +
        'nClassName = "Win32_Service";'#10#9'Description = "Carga archivos en ' +
        'la memoria para imprimirlos despu'#1081's.";'#10#9'DesktopInteract = TRUE;'#10 +
        #9'DisplayName = "Cola de impresi'#1091'n";'#10#9'ErrorControl = "Normal";'#10#9'E' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Servicio de restauraci'#1091'n de sistema";'#10#9'Check' +
        'Point = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description = ' +
        '"Realiza funciones de restauraci'#1091'n del sistema. Para detener el ' +
        ...
        'layName = "Servicio de restauraci'#1091'n de sistema";'#10#9'ErrorControl =' +
        ...
        'ilita el descubrimiento de dispositivos UPnP en su red dom'#1081'stica' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' TRUE;'#10#9'Caption = "Adquisici'#1091'n de im'#1073'genes de Windows (WIA)";'#10#9'C' +
        'heckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Descriptio' +
        'n = "Proporciona servicios de digitalizaci'#1091'n de im'#1073'genes para es' +
        'c'#1073'neres y c'#1073'maras.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "A' +
        'dquisici'#1091'n de im'#1073'genes de Windows (WIA)";'#10#9'ErrorControl = "Norma' +
        ...
        'ministra instant'#1073'neas de volumen basadas en software y tomadas p' +
        'or el Servicio de instant'#1073'neas de volumen. Si se detiene el serv' +
        'icio, no se podr'#1073'n administrar las instant'#1073'neas de volumen basad' +
        'as en software. Si se deshabilita el servicio, no se podr'#1073' inici' +
        'ar ninguno de los servicios que dependen expl'#1085'citamente de '#1081'l.";' +
        ...
        'oint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description = "' +
        'Recopila informaci'#1091'n de rendimiento de equipos locales o remotos' +
        ' de acuerdo a par'#1073'metros de programaci'#1091'n configurados previament' +
        'e, luego guarda la informaci'#1091'n en un registro o emite una alerta' +
        '. Si se detiene el servicio, no se recopilar'#1073' la informaci'#1091'n de ' +
        'rendimiento. Si se deshabilita el servicio, no se podr'#1073' iniciar ' +
        'ninguno de los servicios que dependan expl'#1085'citamente de '#1081'l.";'#10#9'D' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = TRUE;'#10#9'AcceptStop = ' +
        'TRUE;'#10#9'Caption = "Telefon'#1085'a";'#10#9'CheckPoint = 0;'#10#9'CreationClassNam' +
        'e = "Win32_Service";'#10#9'Description = "Ofrece compatibilidad con l' +
        'a API de telefon'#1085'a (TAPI) para programas que controlan dispositi' +
        'vos de telefon'#1085'a y conexiones de voz basadas en IP en el equipo ' +
        'local y, a trav'#1081's de la LAN, en servidores que utilizan tambi'#1081'n ' +
        'el servicio.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Telefon' +
        #1085'a";'#10#9'ErrorControl = "Normal";'#10#9'ExitCode = 0;'#10#9'Name = "TapiSrv";' +
        ...
        'o remoto para administradores), Cambio r'#1073'pido de usuarios, Asist' +
        ...
        '= "Win32_Service";'#10#9'Description = "Proporciona administraci'#1091'n de' +
        ...
        'o inicie sesi'#1091'n en el equipo y ejecute programas , y sea compati' +
        ...
        'ble que el acceso al usuario remoto no est'#1081' disponible. Si este ' +
        'servicio est'#1073' deshabilitado, cualquier servicio que expl'#1085'citamen' +
        'te dependa de '#1081'l no podr'#1073' iniciarse.";'#10#9'DesktopInteract = FALSE;' +
        ...
        'cription = "Mantiene v'#1085'nculos entre archivos NTFS dentro de un e' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Sistema de alimentaci'#1091'n ininterrumpida";'#10#9'Ch' +
        'eckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description' +
        ' = "Administra un sistema de alimentaci'#1091'n ininterrumpida (UPS) c' +
        'onectado al equipo.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "' +
        'Sistema de alimentaci'#1091'n ininterrumpida";'#10#9'ErrorControl = "Normal' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Instant'#1073'neas de volumen";'#10#9'CheckPoint = 0;'#10#9 +
        'CreationClassName = "Win32_Service";'#10#9'Description = "Administra ' +
        'e implementa Instant'#1073'neas de volumen usadas para copias de segur' +
        'idad y otros prop'#1091'sitos. Si este servicio se detiene, las instan' +
        't'#1073'neas se deshabilitar'#1073'n para la copia de seguridad y '#1081'sta dar'#1073' ' +
        'un error. Si este servicio est'#1073' deshabilitado, cualquier servici' +
        'o que expl'#1085'citamente dependa de '#1081'l no podr'#1073' iniciarse.";'#10#9'Deskto' +
        'pInteract = FALSE;'#10#9'DisplayName = "Instant'#1073'neas de volumen";'#10#9'Er' +
        ...
        'onizaci'#1091'n de fecha y hora en todos los clientes y servidores de ' +
        'la red. Si se detiene este servicio, no estar'#1073' disponible la sin' +
        'cronizaci'#1091'n de fecha y hora. Si se deshabilita este servicio, no' +
        ' se podr'#1073' iniciar ninguno de los servicios que dependen expl'#1085'cit' +
        ...
        'nciones no estar'#1073'n disponibles. Si este servicio est'#1073' deshabilit' +
        'ado, cualquier servicio que expl'#1085'citamente dependa de '#1081'l no podr' +
        #1073' iniciarse.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Cliente' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = TRUE;'#10#9'AcceptStop = ' +
        'TRUE;'#10#9'Caption = "Instrumental de administraci'#1091'n de Windows";'#10#9'C' +
        'heckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Descriptio' +
        'n = "Proporciona una interfaz com'#1098'n y un modelo de objeto para t' +
        'ener acceso a la informaci'#1091'n de administraci'#1091'n acerca de un sist' +
        'ema operativo, dispositivos, aplicaciones y servicios. Si se det' +
        'iene este servicio, la mayor'#1085'a del software basado en Windows no' +
        ' funcionar'#1073' correctamente. Si este servicio est'#1073' deshabilitado, ' +
        'cualquier servicio que expl'#1085'citamente dependa de '#1081'l no podr'#1073' ini' +
        'ciarse.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Instrumental' +
        ' de administraci'#1091'n de Windows";'#10#9'ErrorControl = "Ignore";'#10#9'ExitC' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Servicio del n'#1098'mero de serie de medio port'#1073't' +
        'il";'#10#9'CheckPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Des' +
        'cription = "Recupera el n'#1098'mero de serie de cualquier reproductor' +
        ' de medio port'#1073'til conectado al equipo. Si este servicio se inte' +
        ...
        'icio del n'#1098'mero de serie de medio port'#1073'til";'#10#9'ErrorControl = "No' +
        ...
        'e administraci'#1091'n de Windows";'#10#9'CheckPoint = 0;'#10#9'CreationClassNam' +
        'e = "Win32_Service";'#10#9'Description = "Proporciona informaci'#1091'n de ' +
        'administraci'#1091'n de sistemas a y desde controladores.";'#10#9'DesktopIn' +
        'teract = FALSE;'#10#9'DisplayName = "Extensiones de controlador de In' +
        'strumental de administraci'#1091'n de Windows";'#10#9'ErrorControl = "Norma' +
        ...
        'orciona informaci'#1091'n de la biblioteca de rendimiento desde los pr' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' TRUE;'#10#9'Caption = "Actualizaciones autom'#1073'ticas";'#10#9'CheckPoint = 0' +
        ';'#10#9'CreationClassName = "Win32_Service";'#10#9'Description = "Habilita' +
        ' la descarga e instalaci'#1091'n de actualizaciones de Windows. Si el ' +
        'servicio est'#1073' deshabilitado, este equipo no podr'#1073' usar la caract' +
        'er'#1085'stica Actualizaciones autom'#1073'ticas ni el sitio Web de Windows ' +
        'Update.";'#10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Actualizacio' +
        'nes autom'#1073'ticas";'#10#9'ErrorControl = "Normal";'#10#9'ExitCode = 0;'#10#9'Name' +
        ...
        #10'instance of Win32_Service'#10'{'#10#9'AcceptPause = FALSE;'#10#9'AcceptStop =' +
        ' FALSE;'#10#9'Caption = "Configuraci'#1091'n inal'#1073'mbrica r'#1073'pida";'#10#9'CheckPoi' +
        'nt = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description = "Pr' +
        'oporciona configuraci'#1091'n autom'#1073'tica para los adaptadores 802.11";' +
        #10#9'DesktopInteract = FALSE;'#10#9'DisplayName = "Configuraci'#1091'n inal'#1073'mb' +
        'rica r'#1073'pida";'#10#9'ErrorControl = "Normal";'#10#9'ExitCode = 1077;'#10#9'Name ' +
        ...
        'kPoint = 0;'#10#9'CreationClassName = "Win32_Service";'#10#9'Description =' +
        ' "Administra los archivos de configuraci'#1091'n XML en cada dominio p' +
        'ara el aprovisionamiento de red autom'#1073'tico.";'#10#9'DesktopInteract =' +
